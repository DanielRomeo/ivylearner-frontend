    ...
    <div className={styles.container}>
        ...
        <Container>
          ...
          <Navbar.Collapse id="main-navbar">
            ...
            <div className={styles.navButtons}>
              <Button variant="outline-light" className={styles.loginBtn} href="/signin">Log In</Button>
              <Button variant="success" className={styles.signupBtn} href="/signup">Sign Up Free</Button>
            </div>
          </Navbar.Collapse>
        </Container>
      </Navbar>
        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6}>
              ...
              >
                <h1>Learning that puts <span className={styles.highlight}>you</span> first</h1>
                <p>Empower your future with personalized courses taught by expert instructors. Track your progress, connect with tutors, and learn at your own pace.</p>
                <div className={styles.heroCta}>
                  <Button variant="success" size="lg" className={styles.primaryBtn}>
                    Explore Courses
                  </Button>
                  <Button variant="outline-light" size="lg" className={styles.secondaryBtn}>
                    Become a Tutor
                  </Button>
                </div>
                    ...
                    <Card className={styles.courseCard}>
                      <div className={styles.courseImageContainer}>
                        ...
                        <div className={styles.courseOverlay}>
                          <Button variant="light" className={styles.previewBtn}>Preview</Button>
                        </div>
                      </div>
                      <Card.Body>
                        ...
                        <div className={styles.cardFooter}>
                          <Button variant="outline-success" className={styles.courseBtn}>Learn More</Button>
                        </div>
                      </Card.Body>
                    </Card>
                  </motion.div>
              ...
              {[
                {
                  ...
                  description: "Browse through our catalog of premium courses taught by industry experts."
                },
                {
                  number: "02",
                  title: "Learn at Your Pace",
                  description: "Access video lectures, quizzes, and resources whenever and wherever you want."
                },
                {
                  number: "03",
                ...
                },
                {
                  number: "04",
                  title: "Get Certified",
                  description: "Earn certificates that showcase your newly acquired skills to employers."
                }
              ].map((step, index) => (
                <Col md={3} key={index}>
          ...
          <Row className="align-items-center">
            ...
            <Col lg={6}>
              ...
              >
                ...
                <p>Join our community of expert instructors and share your knowledge with students worldwide. Create engaging courses, build your audience, and earn income while making a difference.</p>
                ...
                <Button variant="success" size="lg" className={styles.instructorCta}>
                  Apply as Instructor
                </Button>
              </motion.div>
            </Col>
      ...
      <section className={styles.partnersSection}>
        <Container>
          ...
          >
            <Row className="align-items-center">
              {["university1.png", "company1.png", "university2.png", "company2.png", "university3.png"].map((logo, index) => (
        ...
        <Container>
          <Row>
            <Col lg={4} md={6} className={styles.footerBrand}>
              ...
              <p>Continuing education for everyone. Learn at your own pace with expert-led courses designed for real-world skills.</p>
